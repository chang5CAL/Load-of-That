		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(Activities, { events: this.state.events, remove: this.remove, replace: this.replace })
				)
			);
		}
	});
	...
	var SearchForm = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        "button",
	        { onClick: this.hello.bind(null, this.state.location, this.state.type) },
	        "Submit"
	      )
	    );
	  }
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						"button",
						{ className: "activity-url", onClick: this.props.replace },
						"Add to Calendar "
					),
					React.createElement(
						"p",
