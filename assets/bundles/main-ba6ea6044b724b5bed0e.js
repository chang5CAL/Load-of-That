...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var AddedEvents = __webpack_require__(176);
	...
	var RightCol = React.createClass({
		...
		login: function () {
			if (document.getElementById("a-t")) {
				var type = document.getElementById("email_type").value;
				return React.createElement(
					'div',
					null,
					React.createElement(
				...
				return React.createElement(
					...
					React.createElement(
						'a',
						{ href: 'https://accounts.google.com/o/oauth2/v2/auth?client_id=1084307285600-c271knciittbj18tj02nornfvmangnoa.apps.googleusercontent.com&response_type=code&scope=openid https://www.googleapis.com/auth/calendar&redirect_uri=http://localhost:8000/api/google&state=12345' },
						'Google'
					)
				);
			}
