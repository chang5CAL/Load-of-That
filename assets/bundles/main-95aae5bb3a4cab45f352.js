...
/***/ function(module, exports, __webpack_require__) {
	...
	var Container = React.createClass({
		...
		addEvent: function (event) {
			...
			if (this.state.listOfEvents == 1 && !this.state.show) {
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(RightCol, { listOfEvents: this.state.listOfEvents, addToCalendar: this.addToCalendar, show: this.state.show, showLogin: this.login })
			);
		}
	});
