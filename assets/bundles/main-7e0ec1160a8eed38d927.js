		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					'div',
					null,
					React.createElement(SearchForm, { newQuery: this.state.newQuery }),
					React.createElement(Activities, { events: this.state.events, remove: this.remove, newQuery: this.newQuery })
				)
			);
		}
	});
	...
	var SearchForm = React.createClass({
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					"button",
					{ onClick: this.newQuery.bind(null, this.state.location, this.state.type) },
					"Submit"
				)
			);
		}
