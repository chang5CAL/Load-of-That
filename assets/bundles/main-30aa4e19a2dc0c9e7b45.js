	...
	var Activities = React.createClass({
					...
					render: function () {
									return React.createElement(
													...
													React.createElement(Activity, { title: 'hello1' }),
													React.createElement(Activity, { title: 'hello2' }),
													React.createElement(Activity, { title: 'hello3' }),
													React.createElement(Activity, { title: 'hello4' }),
													React.createElement(Activity, { title: 'hello5' }),
													React.createElement(Activity, { title: 'hello6' })
									);
					}
	});
