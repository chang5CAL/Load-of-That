	...
	var Container = React.createClass({
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(LeftCol, { events: this.state.events, remove: this.remove, newQuery: this.newQuery, add: addEvent }),
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					'div',
					null,
					React.createElement(SearchForm, { newQuery: this.newQuery }),
					React.createElement(Activities, { events: this.state.events, remove: this.remove, add: this.addEvent })
				)
			);
		}
	});
